  ...
  return <main><Header />
    ...
    <section className="home-services">
      ...
      <div className="home-services-grid six">
        <Link href="/servizi"><small>01</small><h3>Diagnosi elettronica</h3><p>Ricerca guasti, spie e anomalie.</p><span>→</span></Link>
        <Link href="/servizi"><small>02</small><h3>Tagliandi</h3><p>Olio, filtri e manutenzione programmata.</p><span>→</span></Link>
        <Link href="/servizi"><small>03</small><h3>Meccanica</h3><p>Freni, sospensioni e riparazioni.</p><span>→</span></Link>
        <Link href="/servizi"><small>04</small><h3>Gommista</h3><p>Montaggio, equilibratura e riparazioni.</p><span>→</span></Link>
        <Link href="/servizi"><small>05</small><h3>Controlli</h3><p>Verifiche generali e sicurezza.</p><span>→</span></Link>
        <Link href="/servizi"><small>06</small><h3>Soccorso stradale</h3><p>Assistenza e recupero del veicolo.</p><span>→</span></Link>
      </div>
    </section>
    <Footer />
  </main>;
