...
export function Header() {
  return <>
    ...
    <header className="site-header">
      <Link className="brand" href="#top" aria-label="Auto Service UNO, inizio pagina">
        <img src={`${base}/logo-auto-service.png`} alt="Auto Service UNO · Officina e Gommista" />
      </Link>
      <nav aria-label="Navigazione principale"><Link href="#top">Home</Link><Link href="#servizi">Servizi</Link><Link href="#officina">Officina</Link><Link href="#contatti">Contatti</Link></nav>
...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div><p className="footer-label">SERVIZI</p><Link href="#servizi">Diagnosi e meccanica</Link><Link href="#servizi">Pneumatici e controlli</Link><Link href="#soccorso">Soccorso stradale</Link></div>
